...
/**
 * WebPerusahaanSearch represents the model behind the search form of `common\models\WebPerusahaan`.
 */
class WebPerusahaanSearch extends WebPerusahaan
{
    /**
     * {@inheritdoc}
     */
