...
/**
 * DashboardSeleksiSearch represents the model behind the search form of `frontend\models\Dashboard\DashboardSeleksi`.
 */
class DashboardSeleksiSearch extends DashboardSeleksi
{
    /**
     * {@inheritdoc}
     */
