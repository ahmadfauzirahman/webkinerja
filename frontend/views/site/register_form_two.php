...
<div class="row">
    ...
    <div class="large-6 small-12 column">
        ...
        <div class="form-group">
            <label class="col-lg-5">Tipe Akun Pelamar <span class="text-danger">*</span></label>
            <div class="col-lg-7">
                <?= $form->field($model, 'role')->radioList(['umum' => 'Umum', 'alumni' => 'Alumni', 'mahasiswa' => 'Mahasiswa'])->label(false); ?>
            </div>
        </div>
