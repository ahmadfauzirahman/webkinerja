...
use frontend\models\User\DashboardLamaranDiterima;
use frontend\models\User\DashboardLamaranDiterimaSearch;
use Yii;
 ...
 */
class DashboardLamaranDiterimaController extends Controller
{
    /**
     * {@inheritdoc}
     */
    public function behaviors()
    {
        ...
        $this->view->params['dashboard-lamaran-diterima'] = true;
    ...
    /**
     * Lists all DashboardLamaranDiterima models.
     * @return mixed
     */
    public function actionIndex()
    {
        if(!Yii::$app->user->isGuest) {
            $searchModel = new DashboardLamaranDiterimaSearch();
            $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

            return $this->render('../dashboard/DashboardLamaranDiterima/index', [
    ...
    {
        if(!Yii::$app->user->isGuest) {
            return $this->render('../dashboard/DashboardLamaranDiterima/view', [
...
//        }
//
//        return $this->render('../dashboard/DashboardLamaranDiterima/create', [
//            'model' => $model,
//        ]);
//    }
...
//        }
//
//        return $this->render('../dashboard/DashboardLamaranDiterima/update', [
//            'model' => $model,
//        ]);
//    }
    ...
    {
        if (($model = DashboardLamaranDiterima::find()->where(['lamaranID' => $id,'lamaranUserID' => Yii::$app->user->identity->userID])->one()) !== null) {
            return $model;
        }
