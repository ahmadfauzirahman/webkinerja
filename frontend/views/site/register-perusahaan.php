        ...
        <div class="large-8 column">
            <div class="section-header animate " data-animate="fadeInUp" data-duration="1s" data-delay="0.1s" data-offset="50">
                <div class="el-content text-left  animate " data-animate="fadeInUp" data-duration="1s" data-delay="0.1s" data-offset="50">
                    <p class="el-subtitle">REGISTER PERUSAHAAN</p>
                    <h2 class="el-title" style="text-shadow: 5px 5px 5px #dddddd;">Daftarkan perusahaan anda sekarang juga!</h2>
        ...
        <div class="large-12 large-centered column">
            <div class="section-header animate " data-animate="fadeInUp" data-duration="1s" data-delay="0.1s" data-offset="50">
                ...
                <div class="user-form">
                    ...
                    <?= $this->render('register_form_two_perusahaan', [
                        'model' => $model,
                        'model2' => $model2,
                    ]) ?>
