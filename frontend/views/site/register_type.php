    ...
    <div class="row">
        <div class="large-7 large-centered column">
            <div class="section-header text-center   animate " data-animate="fadeInUp" data-duration="1s" data-delay="0.1s" data-offset="50">
                <p class="el-subtitle">SELAMAT DATANG DI MENU</p>
                <h2 class="el-title">Registrasi Akun Baru</h2>
            ...
            <div class="large-6 column text-center   animate " data-animate="fadeInUp" data-duration="1s" data-delay="0.1s" data-offset="50">
                ...
                <div class="el-title">
                    <a href="<?= Yii::$app->urlManager->createUrl(['site/register-form']) ?>&mode=one" class="btn btn-lg btn-warning">Sebagai Perusahaan</a>
                </div>
            </div>
            ...
            <div class="large-6 column text-center   animate " data-animate="fadeInUp" data-duration="1s" data-delay="0.1s" data-offset="50">
                ...
                <div class="el-title">
                    <a href="<?= Yii::$app->urlManager->createUrl('site/register-form') ?>&mode=two" class="btn btn-lg btn-success">Sebagai Pelamar</a>
                </div>
            </div>
