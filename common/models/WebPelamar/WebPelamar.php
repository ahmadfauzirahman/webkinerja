...
namespace common\models\WebPelamar;
...
class WebPelamar extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['pelamarNama', 'pelamarTmptLahir', 'pelamarKewarganegaraan', 'pelamarTelfon', 'pelamarNamaAyah', 'pelamarNamaIbu', 'pelamarPekerjaanIbu'], 'string', 'max' => 100],
            [['pelamarJK', 'pelamarTinggiBadan', 'pelamarBeratBadan', 'pelamarGolDarah'], 'string', 'max' => 10],
            [['pelamarAgama', 'pelamarEmail'], 'string', 'max' => 50],
            [['pelamarUserID'], 'required'],
        ];
    }
