            ...
            <div class="row">
                ...
                <div class="large-7 small-2 column">
                    ...
                    <ul class="menu dropdown float-right menu-main hide-for-small-only" data-dropdown-menu>
                        <li>
                            <a href="<?= Yii::$app->urlManager->createUrl(['event-perusahaan/index','id'=>$this->params['id']]) ?>" class="<?php if(isset($this->params['active_home'])){ echo $this->params['active_home'];}?>">Home</a>
                        </li>
                        <li>
                            <a href="<?= Yii::$app->urlManager->createUrl(['event-perusahaan/registrasi', 'id'=>$this->params['id']]) ?>" class="<?php if(isset($this->params['active_regist'])){ echo $this->params['active_regist'];}?>">Registrasi</a>
                        </li>
                        <li >
                            <a href="<?= Yii::$app->urlManager->createUrl(['event-perusahaan/denah', 'id'=>$this->params['id']]) ?>" class="<?php if(isset($this->params['active_denah'])){ echo $this->params['active_denah'];}?>">Denah</a>
                        </li>
                        <li>
                            <a href="<?= Yii::$app->urlManager->createUrl(['event-perusahaan/jadwal', 'id'=>$this->params['id']]) ?>" class="<?php if(isset($this->params['active_jadwal'])){ echo $this->params['active_jadwal'];}?>">Jadwal</a>
                        </li>
