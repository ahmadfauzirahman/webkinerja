...
<div class="dashboard-lowongan-index">
    ...
    <h4 class="el-subtitle">Pelamar Lowongan Anda</h4>
...
//            ),
            ...
            [
                'label' => 'Total Pelamar',
                'value' => function($model){
                    return count(\common\models\WebLamaran\WebLamaran::find()->where(['lamaranLowonganID' => $model->lowonganID])->all())." Orang";
                }
            ],
            ...
            ['class' => 'yii\grid\ActionColumn',
                'buttons' => [
                    ...
                    'view' => function($url,$model){
                        return Html::a('<span class="fa fa-users"></span>', ['/dashboard-perusahaan-lamaran','lowongan' => $model->lowonganID], ['title' => 'List Pelamar','aria-label' => "List Pelamar", 'data-pjax' => 0]);
                    },
