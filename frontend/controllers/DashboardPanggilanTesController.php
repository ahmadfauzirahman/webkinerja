 ...
 */
class DashboardPanggilanTesController extends Controller
{
    /**
     * {@inheritdoc}
     */
    public function behaviors()
    {
        ...
        $this->view->params['dashboard-panggilan-tes'] = true;
    ...
    public function actionIndex()
    {
        if(!Yii::$app->user->isGuest) {
            ...
            return $this->render('../dashboard/DashboardPanggilanTes/index', [
    ...
    {
        if(!Yii::$app->user->isGuest) {
            return $this->render('../dashboard/DashboardPanggilanTes/view', [
...
//        }
//
//        return $this->render('../dashboard/DashboardPanggilanTes/create', [
//            'model' => $model,
//        ]);
//    }
...
//        }
//
//        return $this->render('../dashboard/DashboardPanggilanTes/update', [
//            'model' => $model,
//        ]);
//    }
